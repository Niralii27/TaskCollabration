...
{
    public class TeamLeaderProfileModel
    {
        ...
        public List<TeamLeaderProfileModel> SettingList1 { get; set; } = new List<TeamLeaderProfileModel>(); // Initialize by default


        //Retrieve all records from a Users Table
        public List<TeamLeaderProfileModel> getdata(int userId)
        {
            List<TeamLeaderProfileModel> lstuser = new List<TeamLeaderProfileModel>();
            ...
            {
                lstuser.Add(new TeamLeaderProfileModel
                {
        ...
        public TeamLeaderProfileModel getData(string Id)
        {
            TeamLeaderProfileModel admin = new TeamLeaderProfileModel();
        ...
        public bool update(TeamLeaderProfileModel model)
        {
